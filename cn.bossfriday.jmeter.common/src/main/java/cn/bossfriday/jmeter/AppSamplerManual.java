...
public class AppSamplerManual {
    ...
    public static String getDocument() {
        ...
        sb.append("mobile: getMobile(138, #{sampleIndex})" + CONST_LF);
        sb.append(CONST_LF);
        ...
        sb.append("localhost:9033/baseCheck?mobile=getMobile(138, #{sampleIndex})" + CONST_LF);
        sb.append(CONST_LF);

        sb.append("3. Header Example:" + CONST_LF);
        sb.append("content-type: application/json" + CONST_LF);
        sb.append("uid: #{sampleIndex}" + CONST_LF);
        sb.append("mobile: getMobile(138, #{sampleIndex})" + CONST_LF);
        sb.append(CONST_LF);
        ...
        sb.append("mobile=getMobile(138, #{sampleIndex})&region=86&deviceCode=1" + CONST_LF);
        sb.append(CONST_LF);
        ...
        sb.append("getMobile(138, #{sampleIndex});$.data.uid;$.data.appToken;$.data.imToken" + CONST_LF);
        sb.append(CONST_LF);

        sb.append("7. Preset Inner Args: #{sampleIndex}" + CONST_LF);
        sb.append(CONST_LF);

        sb.append("8. Implemented Functions:" + CONST_LF);
